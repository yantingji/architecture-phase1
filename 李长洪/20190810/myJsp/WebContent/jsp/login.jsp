	...
	<div class="reghtdiv">
		...
		<div id="boy">
        	<div id="boyin">
             ...
             <form action=http://localhost:8080/myJsp/jsp/homePage.jsp method="post">
                        用户名：<br />
                        <input type="text" name="username" class="input_text"><br />
                        密码：<br />
                        <input type="password" name="password" class="input_pwd"><br />
                        <div class="spn_bun">
                        ...
                        <div class="zhanghao">
                        没有账号？<a href="#" class="lianjie">点击注册</a>
                        </div>
                    </form>
                </div>
         </div>
